...
//                    }
                ...
                <!--Form for choices-->
                <form method="post" action="../../../Controller/Spanish/timed/process.php">
            ...
            <a id="startover" href="../../Spanish/spanishhome.php" class="start">Return to Spanish</a>
        ...
        <script>
            ...
            var interval = setInterval(function () {
                ...
                if (timer === 0) {  //if timer runs out..
                    ...
                    window.alert("Game Over"); //user alert "game over"
