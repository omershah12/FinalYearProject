...
$query = "SELECT * FROM overallIncorrectSpanish WHERE userID = $user";
$results = $mysqli->query($query);
$incorrect = $results->num_rows;

//Get list of all Spanish words, from here they will not have been words from
//user inputs
$query = "SELECT * FROM testSpanishWord WHERE wordID <= 53";
...
<html>
    <head>
        ...
        <title>TLL- Beginner Spanish Learning Environment</title>
        ...
        <div class="wrapper">
            <div class="container-fluid text-center">    
                <div class="row content">
                    <div class="col-sm-12">
                        <div class="jumbotron">
                            <h1>Welcome to the Basic Spanish Learning Environment</h1>
                            <p>Here you will be tested on basic Spanish words and phrases through different techniques</p>
                        </div>
                    </div>
                </div>
            </div>
