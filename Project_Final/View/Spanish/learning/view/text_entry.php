                ...
                <div class="row content">
                    <div class="col-sm-12">
                        <div class="jumbotron">
                            ...
                            <h1>Question</h1>
                            <p>English Word <?php echo $question['word']; ?> </p>
                            <p>Translation...?</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row-content">
                    <div class="col-sm-12 text-center">
                         <!--Question for user-->
                        <p><strong>What is the translation for the word "<?php echo $question['word'] ?>"</strong></p>
                    </div>
                </div>
            </div>
            <main>           
                    ...
                    <div class="row-content">
                        <div class="col-sm-12 text-center">
                            ...
                            <form name="form" method="post" action="../controller/textentry_process.php" onsubmit="return validateForm()">
                                ...
                                <input type='button' id='a-acute' value='á' onclick="document.form.user_answer.value += 'á'">
                                <input type='button' id='e-acute' value='é' onclick="document.form.user_answer.value += 'é'">
                                <input type='button' id='i-acute' value='í' onclick="document.form.user_answer.value += 'í'">
                                <input type='button' id='o-acute' value='ó' onclick="document.form.user_answer.value += 'ó'">
                                <input type='button' id='U-with-acute' value='ú' onclick="document.form.user_answer.value += 'ú'">
                                <input type='button' id='tilded-n' value='ñ' onclick="document.form.user_answer.value += 'ñ'">
                                <input type='button' id='U-with-umlaut' value='ü' onclick="document.form.user_answer.value += 'ü'">
                                <input type='button' id='upsidedownexclamation' value='¡' onclick="document.form.user_answer.value += '¡'">
                                <input type='button' id='upsidedownquestionmark' value='¿' onclick="document.form.user_answer.value += '¿'">
