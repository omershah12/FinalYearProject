...
//find max number of words for spanish
$query = "SELECT MAX(questionID)AS total FROM testSpanishChoice";
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>TLL- Beginner Spanish Quiz-Text Entry</title>
...
<!--Main Body of Page-->
    <body>
        ...
        <header>
            <div class="container">
                <center><h1>Quiz- Beginner Spanish 1</h1></center>
            </div>
        </header>
