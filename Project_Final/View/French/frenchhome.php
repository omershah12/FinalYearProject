...
//Including frenchprogress_process.php file, which provides all the information
//concerning the progress half of the page
include '../../Controller/French/frenchprogress_process.php';
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Languages <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="../Spanish/spanishhome.php">Spanish</a></li>
                            </ul>
                        </li>
            ...
            <div class="container-fluid text-center"> 
                ...
                <div class="row content">
                    ...
                    <div class="col-sm-3 text-left">
                        ...
                        <br>
                        <p>This is the home page for French. Here you can test yourself and learn new words and phrases in the language of French.</p>
                        <br>
                    ...
                    <div class="col-sm-3">
                        ...
                        <p><a href="../French/learning/view/index.php?start=1&last=10" class="start" data-toggle='tooltip' title='Learn 1 basic French Words!'> Basic French 1-10 Learning</a></p>

                        <p><a href="../French/learning/view/index.php?start=10&last=20" class="start" data-toggle='tooltip' title='Learn 1 basic French Words!'> Basic French 10-20 Learning</a></p>

                        <p><a href="../French/learning/view/index.php?start=20&last=30" class="start" data-toggle='tooltip' title='Learn 1 basic French Words!'> Basic French 20-30 Learning</a></p>

                        <p><a href="../French/learning/view/index.php?start=30&last=40" class="start" data-toggle='tooltip' title='Learn 1 basic French Words!'> Basic French30-40 Learning</a></p>

                        <p><a href="../French/learning/view/index.php?start=40&last=50" class="start" data-toggle='tooltip' title='Learn 1 basic French Words!'> Basic French30-40 Learning</a></p>
                    </div>
                    <div class="col-sm-4">
                        <h2>Prototypes</h2>
                        <br>
                        <!--All prototypes that were developed, again thr word number is dependent on the start and last values from the url-->
                        <p><a href="../French/multiplechoice/index.php?start=11&last=20" class="start" data-toggle='tooltip' title='Prototype2'> Basic French 11-20</a></p>


                        <p><a href="../French/multiplechoice/index.php?start=1&last=10" class="start" data-toggle='tooltip' title='Prototype1'> Basic French 1-10</a></p>
                        <p><a href="../French/timed/index.php?start=1&last=10" class="start" data-toggle='tooltip' title='Prototype3'> Basic French 1-10 Timed</a></p>


                        <p><a href="../French/learning/view/index.php?start=1&last=10" class="start" data-toggle='tooltip' title='Prototype 4'> Basic French 1-10 Learning</a></p>

                        <p><a href="../French/textentry/index.php?start=1&last=10" class="start" data-toggle='tooltip' title='Prototype5'> Basic French 1-10- Text</a></p>
                ...
                <div class="row-content">
                    <div class="col-sm-6">
                        ...
                        <div class="pre-scrollable">
                            ...
                            <h4><?php echo $correctsofar; ?> out of 53 learned so far</h4>
                            ...
                            <p><?php
                                if ($result->num_rows > 0) {
                                    ...
                                    <p><?php
                                        ...
                                        echo"<br>";
                                        ?><progress id="progress" value="<?php echo $row['COUNT(overallCorrect.wordID)']; ?>" max="25">
                                        </progress>   
                                        <?php
                                    }
                                } else {
                    ...
                    <div class="col-sm-6">   
                      ...
                      <div id="wordcloud"> 
                            ...
                            $wordArray = array();
                            $query = "SELECT COUNT(overallIncorrect.wordID), testFrenchWord.word, "
                                    . "testFrenchWord.translation FROM testFrenchWord "
                                    . "INNER JOIN overallIncorrect ON testFrenchWord.wordID=overallIncorrect.wordID "
                                    . "WHERE overallIncorrect.userID= $userid "
                                    . "GROUP BY overallIncorrect.wordID ORDER BY COUNT(overallIncorrect.wordID) desc";

                            if ($result = $mysqli->query($query)) {
                                while ($row = $result->fetch_assoc()) {
                                    //if there is a result, for every result the transaltion is assigned with its count
                                    $translation = $row["translation"];
                                    $count = $row["COUNT(overallIncorrect.wordID)"];
...
$counter = 0;
$query = "SELECT * FROM frenchScores WHERE userID=$userid";
