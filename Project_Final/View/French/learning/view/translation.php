            ...
            <div class="container-fluid">
                <div class="row-content">
                    <div class="col-sm-12 text-center">
                        ...
                        <form id="form" name="form" method="post" action="../controller/translationprocess.php">
       ...
       <!--Script to hear pronunciation of word using SpeechSynth API-->
        <script>
            function talk() {
                ...
                su.lang = "fr";//french Voice
                su.text = "<?php echo $question['translation']; ?>";   //to say correct word
        ...
        <script type="text/javascript">
            ...
            recognition.lang = "fr"; //french accent
