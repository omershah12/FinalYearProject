...
$query = "INSERT INTO frenchScores(userID, score) VALUES ($userid, $score)";
                            ...
                            <p><?php
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "Word: " . $row["word"] . " - Translation: " . $row["translation"] . " <br> Counts-" . $row["COUNT(testFrenchQuizCorrect.wordID)"] . "<br><br>";
                                    }
                                } else {
                            ...
                            <p><?php
                                if ($incorrecrtResult->num_rows > 0) {
                                    while ($rows = $incorrecrtResult->fetch_assoc()) {
                                        echo "Word: " . $rows["word"] . " - Translation: " . $rows["translation"] . "<br> Counts-" . $rows["COUNT(testFrenchQuizIncorrect.wordID)"] . "<br><br>";
                                    }
                                } else {
